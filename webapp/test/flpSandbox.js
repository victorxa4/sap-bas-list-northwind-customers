		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind Customer Details",
									"targetURL": "#northwindtest2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"northwindtest2-display": {
								"semanticObject": "northwindtest2",
								"action": "display",
								"description": "NCD",
								"title": "Northwind Customer Details",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwindtest2",
									"url": sap.ui.require.toUrl("northwindtest2")
								}
							}
						}
					}
